...
#Configura RTC Clock
    try:
        i2c_RTC = machine.I2C(id=1, sda=machine.Pin(6), scl=machine.Pin(7))
    except Exception as e:
        print("ERRO NO RTC:", e)
    else:
        time.sleep(0.5)
...
try:
    i2c_sens = machine.I2C(id=0, sda=machine.Pin(16), scl=machine.Pin(17), freq=100000) # Os sensores estão nos mesmo pins
...
try:
    ens = ENS160.ENS160(i2c_RTC) # ENS160
